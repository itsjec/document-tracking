          ...
          <div class="card-body">
            <div class="steps d-flex flex-wrap flex-sm-nowrap justify-content-between padding-top-2x padding-bottom-1x">
                <div class="step completed">
                    ...
                    <h4 class="step-title">Document Registered</h4>
                </div>
                <div class="step completed">
                    <div class="step-icon-wrap">
                        <div class="step-icon"><i class="pe-7s-check-circle"></i></div>
                    </div>
                    <h4 class="step-title">Approved</h4>
                </div>
                <div class="step completed">
                    <div class="step-icon-wrap">
                    <div class="step-icon"><i class="pe-7s-tools"></i></div>
                    </div>
                    <h4 class="step-title">Processing Document</h4>
                </div>
                <div class="step">
                    <div class="step-icon-wrap">
                    <div class="step-icon"><i class="pe-7s-news-paper"></i></div>
                    </div>
                    <h4 class="step-title">Document Confirmation</h4>
                </div>
                <div class="step">
                    <div class="step-icon-wrap">
                    <div class="step-icon"><i class="pe-7s-check"></i></div>
                    </div>
                    <h4 class="step-title">Document Completed</h4>
                </div>
                </div>
