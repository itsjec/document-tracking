      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="./internalincoming" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="./internaloutgoing" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="./internalpending">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="./internalreports">
              <span class="menu-icon">
